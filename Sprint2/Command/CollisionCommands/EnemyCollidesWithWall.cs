...
namespace Sprint2
{
    class EnemyCollidesWithWall : ICollisionCommand
    {
        private Enemies enemy;
        private Wall wall;
        private GameObjectManager gom;
        private int side;
        public EnemyCollidesWithWall()
        {

        }
        public void SetCollisionObjects(ISprite enemyObject, ISprite wallObject, CollisionDetector.COLLISION_SIDE collisionSideOfMainObject, GameObjectManager gom)
        {
        ...
        public void Invoke()
        {
            CheckCollisionWithBlock(enemy, wall, side);
        }
    }
}
