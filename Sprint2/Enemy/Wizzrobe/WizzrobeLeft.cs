...
namespace Sprint2
{
	public class WizzrobeLeft : IEnemyState
	{
		...
		public WizzrobeLeft(EnemiesList enemiesList)
		{
			...
			currFrame = 0;
			totalFrames = 2;
			frame1 = SpriteFactory.WIZZROBE_SHEET2MIRROR_LEFT1;
			frame2 = SpriteFactory.WIZZROBE_SHEET2MIRROR_LEFT2;
			this.sheet = wizzrobe.spriteFactory.getEnemySheet2Mirror();
		}
		...
		{
			wizzrobe.currState = new WizzrobeDown(enemiesList);
		}
